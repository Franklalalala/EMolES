...
from emoles.utils.constants import atomic_num_dict, anglrMId, SKBondType
from typing import (
    TYPE_CHECKING,
    Any,
    Callable,
    ...
    if onsitemode ==  "strain":
        for i in onsite_coeff.keys():
            ...
            if format == "EMolES":
                ...
                log.error(msg="Wrong format, please choose from [EMolES] for checkpoint format, or [sktable] for hopping and onsite table.")
                raise ValueError
