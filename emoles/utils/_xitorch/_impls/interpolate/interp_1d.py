...
from emoles.utils._xitorch._impls.interpolate.base_interp import BaseInterp
from emoles.utils._xitorch._impls.interpolate.extrap_utils import get_extrap_pos, get_extrap_val
