...
from emoles.utils.torch_geometric import Batch, Dataset
from emoles.utils.tools import download_url, extract_zip

import emoles
from emoles.data import (
    AtomicData,
    AtomicDataDict,
    _NODE_FIELDS,
    _EDGE_FIELDS,
...
from emoles.utils.batch_ops import bincount
from emoles.utils.regressor import solver
from emoles.utils.savenload import atomic_write
from emoles.data.AtomicData import _NESTED_FIELDS
...
class AtomicDataset(Dataset):
    ...
    def _get_parameters(self) -> Dict[str, Any]:
        ...
        params["EMolES_version"] = emoles.__version__
