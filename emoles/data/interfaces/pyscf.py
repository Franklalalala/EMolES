...
import h5py
import glob
from emoles.utils.constants import orbitalId, Bohr2Ang, PYSCF2EMolES
from scipy.linalg import block_diag
import scipy.constants as const
import numpy as np
from emoles.utils.constants import atomic_num_dict, atomic_num_dict_r, anglrMId
from emoles.utils.symbol2ID import symbol2ID
import argparse
import logging
import pickle
...
class OrbDFT2EMolES:
    def __init__(self, DFT2EMolES = None):
        
        if DFT2EMolES is None:
            DFT2EMolES = PYSCF2EMolES
        self.Us_DFT2EMolES = DFT2EMolES

    def get_U(self, l):
        if l > 5:
            raise NotImplementedError("Only support l = s, p, d, f, g, h.")
        return self.Us_DFT2EMolES[l]
...
def _chkfile_parse(chkfile, 
    ...
    U_orbital = OrbDFT2EMolES(DFT2EMolES = PYSCF2EMolES)
...
def main():
    parser = argparse.ArgumentParser(
                description="EMolES parse QM9 data sets",
